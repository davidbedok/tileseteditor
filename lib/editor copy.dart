...
class TileSetEditorTmp extends StatefulWidget {
  final TileSetProject project;
  final TileSet tileSet;
  final dui.Image tileSetImage;
  final EditorState editorState;

  const TileSetEditorTmp({super.key, required this.project, required this.tileSet, required this.tileSetImage, required this.editorState});

  @override
  State<TileSetEditorTmp> createState() => TileSetEditorTmpState();
}

class TileSetEditorTmpState extends State<TileSetEditorTmp> {
  @override
  void initState() {
    super.initState();
  }
